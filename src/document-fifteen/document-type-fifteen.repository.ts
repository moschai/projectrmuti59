...
export class DocumentTypeFifteenRepository extends Repository<fte_document_type_fifteen>{
    async createDocumentFifteen(
        ...
        documentFifteen.graduationrequestterm = createDocumentFifteenteenDto.graduationrequestterm;
        documentFifteen.graduationrequestyear = createDocumentFifteenteenDto.graduationrequestyear;
        ...
        documentFifteen.typestudy = createDocumentFifteenteenDto.typestudy;
