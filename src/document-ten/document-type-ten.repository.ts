...
export class DocumentTypeTenRepository extends Repository<fte_document_type_ten> {
    ...
    async createDocumentTen(
        ...
        documentTen.classyear = createDocumentTenDto.classyear;
        documentTen.timestudy = createDocumentTenDto.timestudy;
        documentTen.typestudy = createDocumentTenDto.typestudy;
