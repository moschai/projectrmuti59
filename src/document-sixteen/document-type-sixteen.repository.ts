...
export class DocumentTypeSixteenRepository extends Repository<
  fte_document_type_sixteen
> {
  async createDocumentSixteen(
    ...
    documentSixteen.delaygraduationterm =
      createDocumentSixteenDto.delaygraduationterm;
    documentSixteen.delaygraduationyear =
      createDocumentSixteenDto.delaygraduationyear;
    documentSixteen.classyear = createDocumentSixteenDto.classyear;
    documentSixteen.timestudy = createDocumentSixteenDto.timestudy;
    documentSixteen.dear = createDocumentSixteenDto.dear;
    documentSixteen.since = createDocumentSixteenDto.since;
