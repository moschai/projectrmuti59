...
@Entity()
export class fte_signature_sixteen extends BaseEntity {

    @PrimaryGeneratedColumn()
    idsig: number;

    @OneToOne(type => fte_document_type_sixteen, sixteen => sixteen.signature, { eager: false })
    type: fte_document_type_sixteen;
