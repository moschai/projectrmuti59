import { Entity, BaseEntity, PrimaryGeneratedColumn, Column, OneToOne, JoinColumn, OneToMany, ManyToOne, UpdateDateColumn, } from "typeorm";
...
export class fte_student extends BaseEntity {
    ...
    @OneToOne(type => fte_document, document => document.student, { eager: false })
    // @JoinColumn({name:'id_document'})
    document: fte_document;

    @ManyToOne(type => fte_major, major => major.student, { eager: true })
