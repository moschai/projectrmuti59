import { Entity, BaseEntity, PrimaryGeneratedColumn, Column, UpdateDateColumn, OneToMany, OneToOne, JoinColumn, ManyToOne } from "typeorm";
...
export class fte_document extends BaseEntity {
    ...
    @ManyToOne(type => fte_authority, authority => authority.document, { eager: true })
