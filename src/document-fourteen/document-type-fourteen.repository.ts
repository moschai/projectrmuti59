...
export class DocumentTypeFourteenRepository extends Repository<fte_document_type_fourteen>{
    async createDocumentFourteen(
        ...
        documentFourteen.behavioralreceipt = createDocumentFourteenDto.behavioralreceipt;
