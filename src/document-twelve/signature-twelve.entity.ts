...
@Entity()
export class fte_signature_twelve extends BaseEntity {

    @PrimaryGeneratedColumn()
    idsig: number;

    @OneToOne(type => fte_document_type_twelve, twelve => twelve.signature, { eager: false })
    type: fte_document_type_twelve;
