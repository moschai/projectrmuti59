import { Entity, BaseEntity, PrimaryGeneratedColumn, JoinColumn, ManyToOne, OneToOne, Column } from "typeorm";
...
@Entity()
export class fte_signature_five extends BaseEntity {

    @PrimaryGeneratedColumn()
    idsig: number;

    @OneToOne(type => fte_document_type_five, five => five.signature, { eager: false })
    type: fte_document_type_five;
