...
export class DocumentTypeSevenRepository extends Repository<fte_document_type_seven> {
    ...
    async createDocumentSeven(
        ...
        documentSeven.termtotalunit = createDocumentSevenDto.termtotalunit;
        documentSeven.withdrawregisterunit = createDocumentSevenDto.withdrawregisterunit;
        documentSeven.remainunit = createDocumentSevenDto.remainunit;
