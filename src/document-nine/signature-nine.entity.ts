...
@Entity()
export class fte_signature_nine extends BaseEntity {

    @PrimaryGeneratedColumn()
    idsig: number;

    @OneToOne(type => fte_document_type_nine, nine => nine.signature, { eager: false })
