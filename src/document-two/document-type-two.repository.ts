...
export class DocumentTypeTwoRepository extends Repository<
  fte_document_type_two
> {
  async createDocumentTwo(
    ...
    documentTwo.classyear = createDocumentTwoDto.classyear;
    documentTwo.timestudy = createDocumentTwoDto.timestudy;
