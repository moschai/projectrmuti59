...
export class DocumentTypeSixRepository extends Repository<fte_document_type_six> {
    ...
    async createDocumentSix(
        ...
        documentSix.addregisterunit = createDocumentSixDto.addregisterunit;
        documentSix.termsumtotalunit = createDocumentSixDto.termsumtotalunit;
